...
public class ConversationController {
    ...
    @Operation(summary = "流式调用ollama大模型")
    @GetMapping(value = "/streamOllama", produces = "text/stream;charset=utf-8")
    public Flux<String> streamOllama(@RequestParam String prompt, @RequestParam(required = false) Long sessionId) {
        return conversationService.streamOllama(prompt, sessionId);
    }
